...
class AddAttenderScreen extends StatefulWidget {
  const AddAttenderScreen({super.key});

  @override
  State<AddAttenderScreen> createState() => _AddAttenderScreenState();
}

class _AddAttenderScreenState extends State<AddAttenderScreen> {
  ...
  saveFun() async {
    if (addattenderController.attenderNameC.text.isEmpty ||
        addattenderController.attenderNameC.text.length < 3) {
      setState(() {
        managerNameError = true;
      });
    } else if (addattenderController.attenderEmailC.text.isEmpty ||
        !emailValidation(addattenderController.attenderEmailC.text)) {
      setState(() {
        isEmailError = true;
      });
    } else if (addattenderController.phoneNumberC.text.isEmpty ||
        addattenderController.phoneNumberC.text.length != 10) {
      setState(() {
        phoneNumberError = true;
      });
    } else if (addattenderController.attenderPasswordC.text.isEmpty ||
        addattenderController.attenderPasswordC.text.length < 4) {
      print(password);
      setState(() {
        passwordError = true;
      });
    } else if (addattenderController.attenderConfirmPasswordC.text.isEmpty ||
        addattenderController.attenderConfirmPasswordC.text.length < 4) {
      setState(() {
        cpasswordError = true;
      });
      ...
      //   selectStnError = true;
      // });
    } else if (addattenderController.attenderloginId.text.isEmpty ||
        addattenderController.attenderloginId.text.length < 5) {
      setState(() {
        loginIdError = true;
      });
    } else if (addattenderController.attenderAddressC.text.isEmpty ||
        addattenderController.attenderAddressC.text.length < 5) {
      setState(() {
        addressError = true;
      });
    } else {
      print('goi');
      await addattenderController.validateAddAttenderFun(
        user_token.toString(),
        addattenderController.attenderloginId.text,
        addattenderController.attenderNameC.text,
        addattenderController.attenderEmailC.text,
        addattenderController.phoneNumberC.text,
        addattenderController.attenderPasswordC.text,
        addattenderController.attenderConfirmPasswordC.text,
        addattenderController.attenderAddressC.text,
        '',
        '',
        selectedValue,
        'Attendent',
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBarCustom.commonAppBarCustom(context, title: 'Add Attender',
            onTaped: () {
          ...
          children: [
            Column(
              ...
              children: [
                ...
                CommonTextFieldAuthentication(
                    controller: addattenderController.attenderNameC,
                    hintText: 'Add Attender Name',
                    readOnlytext: false,
                    ...
                    isErrorTextString: 'Please enter attender name',
            ...
            Column(
              ...
              children: [
                ...
                CommonTextFieldAuthentication(
                    controller: addattenderController.attenderEmailC,
            ...
            Column(
              ...
              children: [
                ...
                CommonTextFieldAuthentication(
                    controller: addattenderController.phoneNumberC,
            ...
            Column(
              ...
              children: [
                ...
                TextFormField(
                  controller: addattenderController.attenderPasswordC,
            ...
            Column(
              ...
              children: [
                ...
                TextFormField(
                    controller: addattenderController.attenderConfirmPasswordC,
            ...
            Column(
              ...
              children: [
                ...
                CommonTextFieldAuthentication(
                    controller: addattenderController.attenderloginId,
                    hintText: 'login Id ',
                    readOnlytext: false,
                    typeOfRed: <TextInputFormatter>[
                      FilteringTextInputFormatter.deny(RegExp("[ ]")),
            ...
            Column(
              ...
              children: [
                ...
                CommonTextFieldAuthentication(
                    controller: addattenderController.attenderAddressC,
                    hintText: 'Address',
                    readOnlytext: false,
                    typeOfRed: <TextInputFormatter>[
                      //  FilteringTextInputFormatter.allow(RegExp("[a-z A-Z]")),
            ...
            Obx(
              () => ElevatedButton(
                onPressed: () =>
                    addattenderController.isAddStationMangerLoading.value
                        ? null
                        : saveFun(),
                style: ElevatedButton.styleFrom(
                    ...
                    shape: StadiumBorder()),
                child: addattenderController.isAddStationMangerLoading.value
                    ? SizedBox(
                        height: 15,
                        width: 15,
