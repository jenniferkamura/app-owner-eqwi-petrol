...
class CartScreen extends StatefulWidget {
  ...
  const CartScreen({super.key, required this.notificationsCountFun_value});
...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<void> getcartList() async {
    ...
    Map<String, dynamic> bodyData = {
      ...
      'station_id': selectStationId.toString()
    };
    print(bodyData);
    setState(() {
      isCartloader = true;
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            ...
                                            '${'Deliver: ' + selectedData['station_name'] + ',' + selectedData['contact_person'] + ',' + selectedData['address'] + ',' + selectedData['pincode'] + ',' + selectedData['state']},' +
                                                selectedData['city'],
                                ...
                                onTap: () {
                                  if (stationsCount != 0) {
                                    ...
                                    Fluttertoast.showToast(
                                        ...
                                        msg:
                                            "You have no stations.Please add station",
    ...
    return Container(
      child: Center(
        child: Column(
          children: [
            Image.asset(
              '${StringConstatnts.assets}emptycart.png',
                  ...
                  TextSpan(
                    ...
                    children: <InlineSpan>[
                      TextSpan(
                        //  text: ' (\$ 110 / Litr)',
                        text:
                            '${'${' (' + data['currency'] + ' ' + data['price']} / ' + data['measurement']})',
                        style: GoogleFonts.roboto(
                            fontSize: 10,
                            fontWeight: FontWeight.w500,
