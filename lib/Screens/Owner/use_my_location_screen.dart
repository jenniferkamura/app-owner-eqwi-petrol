...
class UseMyLocationScreen extends StatefulWidget {
  const UseMyLocationScreen({Key? key}) : super(key: key);

  @override
  State<UseMyLocationScreen> createState() => _UseMyLocationScreenState();
}

class _UseMyLocationScreenState extends State<UseMyLocationScreen> {
