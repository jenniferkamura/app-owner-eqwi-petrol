...
import 'package:owner_eqwi_petrol/Screens/Owner/controllers/add_cart_station_controller.dart';
...
class AddCartStationScreen extends StatefulWidget {
  const AddCartStationScreen({Key? key}) : super(key: key);

  @override
  State<AddCartStationScreen> createState() => _AddCartStationScreenState();
}

class _AddCartStationScreenState extends State<AddCartStationScreen> {
  String? user_token = Constants.prefs?.getString('user_token');
  AddcartStationController addStationController =
      Get.put(AddcartStationController());
