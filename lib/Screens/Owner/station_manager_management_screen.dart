...
class StationManagerManagement extends StatefulWidget {
  const StationManagerManagement({super.key});

  @override
  State<StationManagerManagement> createState() =>
      _StationManagerManagementState();
}

class _StationManagerManagementState extends State<StationManagerManagement> {
  ...
  Future<void> getmanagerslist() async {
    managerslist.clear();
    setState(() {
      isLoader = true;
    });
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => AddStationManagerScreen(),
                        ));
                      },
                      child: Text(
                        'Add Manager',
