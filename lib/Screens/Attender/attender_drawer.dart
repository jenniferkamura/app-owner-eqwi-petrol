...
class AttenderNavDrawer extends StatefulWidget {
  @override
  State<AttenderNavDrawer> createState() => _AttenderNavDrawerState();
}

class _AttenderNavDrawerState extends State<AttenderNavDrawer> {
