...
class AttenderHomeScreen extends StatefulWidget {
  final Function notificationsCountFun_value;
  const AttenderHomeScreen(
      {super.key, required this.notificationsCountFun_value});

  @override
  State<AttenderHomeScreen> createState() => _AttenderHomeScreenState();
}

class _AttenderHomeScreenState extends State<AttenderHomeScreen> {
