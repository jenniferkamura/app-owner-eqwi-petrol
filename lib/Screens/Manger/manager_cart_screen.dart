...
class ManagerCartScreen extends StatefulWidget {
  final Function notificationsCountFun_value;
  const ManagerCartScreen(
      {super.key, required this.notificationsCountFun_value});

  @override
  State<ManagerCartScreen> createState() => _ManagerCartScreenState();
}

class _ManagerCartScreenState extends State<ManagerCartScreen> {
